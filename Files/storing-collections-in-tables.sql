...
/
DELETE from emps_with_phones2 WHERE employee_id = 11;
/
...
SET phone_number = n_phone_numbers(t_phone_number('HOME','000.000.000'),
                                   t_phone_number('NEW-WORK','444.444.4444'),
                                   t_phone_number('NEW-WORK2','444.444.4444'),
                                   t_phone_number('NEW-WORK3','444.444.4444'),
                                   t_phone_number('NEW-WORK4','444.444.4444'),
                                   t_phone_number('NEW-WORK5','444.444.4444'))
